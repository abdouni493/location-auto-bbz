    ...
    <div className="min-h-screen bg-vel-void py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                ...
                const content = (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg vel-glass-accent flex items-center justify-center flex-shrink-0">
                      <method.icon size={18} style={{ color: 'var(--color-gold)' }} />
                    </div>
          ...
          >
            <div>
              ...
              <div className="w-10 h-0.5 mt-2 mb-6" style={{ background: 'var(--color-gold)' }} />
            </div>
        ...
        >
          ...
          <div className="w-10 h-0.5 mb-8" style={{ background: 'var(--color-gold)' }} />
              ...
              <div key={i}>
                ...
                <input
                  ...
                  onFocus={e => {
                    ...
                    (e.target as HTMLElement).style.boxShadow = '0 0 0 1px rgba(212,175,55,0.25)';
                  }}
                  onBlur={e => {
