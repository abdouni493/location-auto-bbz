    ...
    <div className="fixed inset-0 flex items-center justify-center p-4 z-50 overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          style={{ background: 'radial-gradient(circle, rgba(212,175,55,0.09), transparent 60%)' }}
        />
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 20px 60px var(--color-border-soft)',
        }}
      >
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="w-20 h-20 rounded-2xl overflow-hidden flex items-center justify-center"
            ...
            {websiteSettings?.logo ? (
              ...
              <Car size={36} style={{ color: 'var(--color-gold)' }} />
            )}
          </div>
        ...
        >
          <CheckCircle size={56} style={{ color: 'var(--color-gold)', filter: 'drop-shadow(0 0 16px rgba(212,175,55,0.35))' }} />
        </motion.div>
        ...
        <div className="space-y-3">
          ...
          <p className="flex items-center justify-center gap-2 text-sm text-vel-muted">
            <PhoneCall size={14} style={{ color: 'var(--color-gold)' }} />
