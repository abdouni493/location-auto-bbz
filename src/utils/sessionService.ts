  ...
  getAuthHeaders(): Record<string, string> {
    ...
    try {
      ...
      return {
        ...
        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpobWt6dmJmaHBwZWVyanFxYnFuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQ2NzI3OTgsImV4cCI6MjEwMDI0ODc5OH0.C_rIxo8Jex9DQeKj-1R46TzhjsWxxO3900_906AcVvc'
      };
    } catch {
      return {};
    }
